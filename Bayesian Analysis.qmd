...
We performed a sensitivity analysis using different combinations of priors. For each parameter ($\alpha$ and $\tau$) we used three different types of prior:
